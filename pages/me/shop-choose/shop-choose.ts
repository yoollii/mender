...
/**
 * Generated class for the ShopChoosePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-shop-choose',
  templateUrl: 'shop-choose.html',
})
export class ShopChoosePage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad ShopChoosePage');
  }
